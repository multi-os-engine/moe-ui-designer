...
public final class SdkConstants {
    public static final String UI_DESINGER_NAME = "UIPrototyper";
    ...
    /** Name of the SDK resources folder, i.e. "resources" */
    public static final String FD_XRT_RESOURCES = "resources";              //$NON-NLS-1$
    ...
    public static final String TAG_XRT_ATTR = "xrt_attr";              //$NON-NLS-1$
    ...
    public static final String NAMESPACE_IBACTION = "xrt:ibaction";
    public static final String NAMESPACE_IBOUTLET = "xrt:iboutlet";
    public static final String XRT_NAMESPACE = "xrt";
    ...
    public static final String NAVIGATION_CONTAINER_TAG_NAME= "com.android.sdklib.widgets.base_elements.iOSNavigationBarContainer";
    public static final String TABLE_HEADER_TAG_NAME= "com.android.sdklib.widgets.iOSTextView";
    public static final String TABLE_TAG_NAME= "com.android.sdklib.widgets.iOSTableView";
    ...
    public static final String INT_NAME_VALUE = "int_name";            //$NON-NLS-1$
    ...
    public static final String SELECTOR_ANNOTATION_PREFIX = "Selector";
    public static final String PROPERTY_ANNOTATION_PREFIX = "Property";

    public enum PRIORITY_PROPERTIES{
        EVENT("events"),
        IBOUTLET("iboutlet"),
        SEGUE("segue"),
        INITIAL_VIEW_CONTROLLER("initialViewController"),
        VIEW_CONTROLLER("viewController");

        private String _name;

        PRIORITY_PROPERTIES(String name){
            _name = name;
        }
        ...
        public static List<String> getNames(){
            ...
            for(PRIORITY_PROPERTIES element : values()){
