        ...
        Thread threadErr = new Thread("stderr") {
            ...
            public void run() {
                ...
                try {
                    ...
                    errReader = new BufferedReader(isr);
                    while (true) {
                    ...
                    try {
                        if (is != null) Closeables.close(is, true /* swallowIOException */);
                    } catch (IOException e) {
                        // cannot happen
                    }
                    try {
                        if (isr != null) Closeables.close(isr, true /* swallowIOException */);
                    } catch (IOException e) {
                        // cannot happen
                    }
                    try {
                        if (errReader != null) Closeables.close(errReader, true /* swallowIOException */);
                    } catch (IOException e) {
                        // cannot happen
                    }
                }
        ...
        Thread threadOut = new Thread("stdout") {
            ...
            public void run() {
                ...
                try {
                    ...
                    isr = new InputStreamReader(is);
                    outReader = new BufferedReader(isr);
                    ...
                    try {
                        if (outReader != null) Closeables.close(outReader, true /* swallowIOException */);
                    } catch (IOException e) {
                        // cannot happen
                    }
                }
