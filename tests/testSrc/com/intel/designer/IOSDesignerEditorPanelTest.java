...
public class IOSDesignerEditorPanelTest extends TestBase {

    public void testButton() throws Exception {
        init();
        IOSDesignerEditorPanel editor = createLayoutEditor(getTestFile("button.ixml"));
        ...
        testString = "RadViewComponent{tag=<LinearLayout>, bounds=[0,0:640x960}\n" +
                ...
                "        RadViewComponent{tag=<com.android.sdklib.widgets.iOSButton>, bounds=[0,75:277x144}";
        assertEquals(testString,
