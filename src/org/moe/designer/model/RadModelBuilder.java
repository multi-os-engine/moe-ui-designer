...
import static org.moe.designer.designSurface.RootView.EMPTY_COMPONENT_SIZE;
import static org.moe.designer.designSurface.RootView.VISUAL_EMPTY_COMPONENT_SIZE;
...
public class RadModelBuilder {
  ...
  private IOSDesignerEditorPanel myDesigner;

  public RadModelBuilder(@NotNull IOSDesignerEditorPanel designer, @NotNull PropertyParser propertyParser) {
    myDesigner = designer;
  ...
  @Nullable
  public static RadViewComponent update(@NotNull IOSDesignerEditorPanel designer,
  ...
  @NotNull
  public static IOSDesignerEditorPanel getDesigner(@NotNull RadComponent component) {
    IOSDesignerEditorPanel designer = component.getRoot().getClientProperty(DESIGNER_KEY);
    if (designer == null) {
      ...
      if (component instanceof RadViewComponent) {
        ...
        for (FileEditor editor : FileEditorManager.getInstance(project).getSelectedEditors()) {
          if (editor instanceof IOSDesignerEditor) {
            return (IOSDesignerEditorPanel)((IOSDesignerEditor)editor).getDesignerPanel();
          }
        }
      }
  ...
  @NotNull
  public static IXmlFile getXmlFile(@NotNull RadComponent component) {
...
//          AndroidMetaModel metaModel = new AndroidMetaModel(myModel.getModel(),myModel.getTarget(),myModel.getTag());
          if (metaModel == null) {
            metaModel = myMetaManager.getModelByTag(VIEW_TAG);
//            metaModel = new AndroidMetaModel(myModel.getModel(),myModel.getTarget(),myModel.getTag());
