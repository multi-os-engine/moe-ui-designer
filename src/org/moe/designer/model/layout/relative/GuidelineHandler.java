...
import org.moe.designer.android.designer.Segment;
import org.moe.designer.android.designer.SegmentType;
import org.moe.designer.model.RadViewComponent;
import org.moe.designer.model.layout.TextDirection;
...
import static org.moe.designer.android.designer.MarginType.*;
//import static com.android.tools.idea.refactoring.rtl.RtlSupportProcessor.RTL_TARGET_SDK_START;
import static org.moe.designer.designSurface.graphics.DrawingStyle.MAX_MATCH_DISTANCE;
import static org.moe.designer.model.layout.relative.ConstraintType.ALIGN_BASELINE;
import static org.moe.designer.model.layout.relative.DependencyGraph.Constraint;
import static org.moe.designer.model.layout.relative.DependencyGraph.ViewData;
...
public class GuidelineHandler {
  ...
  private boolean supportsStartEnd() {
    AndroidFacet facet = IOSDesignerUtils.getFacet(myContext.getArea());
//    if (facet != null) {
...
//    }
  ...
  public int getLeftMarginDp() {
    if (myLeftMargin != 0) {
      JComponent target = myContext.getArea().getFeedbackLayer();
      int dpi = IOSDesignerUtils.getDpi(myContext.getArea());
