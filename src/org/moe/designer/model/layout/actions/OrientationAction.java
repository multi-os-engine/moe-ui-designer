...
public class OrientationAction extends LayoutAction {
  ...
  public OrientationAction(@NotNull DesignerEditorPanel designer,
    ...
    super(designer, "Change attribute 'orientation'", null, IOSDesignerIcons.SwitchHorizontalLinear);
    myLayout = layout;
...
//    }
  ...
  protected void update(Presentation presentation) {
    ...
    Icon icon = myHorizontal ? IOSDesignerIcons.SwitchHorizontalLinear : IOSDesignerIcons.SwitchVerticalLinear;
