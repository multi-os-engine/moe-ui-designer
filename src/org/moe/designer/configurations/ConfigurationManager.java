...
import org.moe.designer.android.sdk.MessageBuildingSdkLog;
import org.moe.designer.rendering.AppResourceRepository;
import org.moe.designer.rendering.LocalResourceRepository;
import org.moe.designer.rendering.ProjectResourceRepository;
import org.moe.designer.uipreview.UserDeviceManager;
import org.moe.designer.rendering.Locale;
...
import static org.moe.designer.configurations.ConfigurationListener.*;
...
//    return new Configuration(this,file,new FolderConfiguration());//configuration;
  }
  ...
  private Configuration create(@NotNull VirtualFile file) {
    ...
    ConfigurationFileState fileState = null;//stateManager.getConfigurationState(file);
    ...
    if (fileState != null) {
      ...
      //TODO:here is hardcoded nexus 4
...
//    }
    return  AndroidPlatform.getSdkData().getTargets();
...
//    return manifest.getDefaultTheme(configuration.getTarget(), configuration.getScreenSize(), configuration.getDevice());
   //TODO:fix hardcoded theme if needed (e.g. when changing from gark to light and vice versa)
