...
public class ConfigurationStateManager implements PersistentStateComponent<ConfigurationStateManager.State> {
  ...
  private static ConfigurationStateManager myStateManager = new ConfigurationStateManager();
  @NotNull
  public static ConfigurationStateManager get(@NotNull Project project) {
    myStateManager = ServiceManager.getService(project, ConfigurationStateManager.class);
    if (myStateManager == null){
      myStateManager = new ConfigurationStateManager();
    }
