...
import org.moe.designer.gradle.ProjectBuilder;
 ...
 */
public class IOSLayoutPreviewToolWindowManager implements ProjectComponent {
  ...
  private IOSLayoutPreviewToolWindowForm myToolWindowForm;
   ...
   * is done
   */
  private IOSPreviewProgressIndicator myCurrentIndicator;

  private static final Object RENDERING_LOCK = new Object();
  private static final Object PROGRESS_LOCK = new Object();

  public IOSLayoutPreviewToolWindowManager(final Project project, final FileEditorManager fileEditorManager) {
    myProject = project;
  ...
  protected void initToolWindow() {
    myToolWindowForm = new IOSLayoutPreviewToolWindowForm(this, getCustomRefreshRenderAction());
      ...
      public void run() {
        ...
        if (toRender) {
          ...
          if (requestedRender) {
            ...
            IOSLayoutPreviewToolWindowForm toolWindowForm = myToolWindowForm;
            synchronized (PROGRESS_LOCK) {
              if (myCurrentIndicator == null) {
                myCurrentIndicator = new IOSPreviewProgressIndicator(toolWindowForm, 0);
  ...
  public static void renderIfApplicable(@Nullable final Project project) {
    if (project != null) {
      ...
      IOSLayoutPreviewToolWindowManager preview = getInstance(project);
      if (preview != null) {
        preview.render();
      }
    }
  ...
  protected boolean render(final PsiFile psiFile, final AndroidFacet facet,
    ...
    getRenderingQueue().queue(new Update("render") {
      ...
      public void run() {
        ...
        }, new IOSPreviewProgressIndicator(myToolWindowForm, 100));
      }
  ...
  private void doRender(@NotNull final AndroidFacet facet, @NotNull final PsiFile psiFile) {
    ...
    final IOSLayoutPreviewToolWindowForm toolWindowForm = myToolWindowForm;
  ...
  public static IOSLayoutPreviewToolWindowManager getInstance(Project project) {
    return project.getComponent(IOSLayoutPreviewToolWindowManager.class);
  }
  ...
  @VisibleForTesting
  public IOSLayoutPreviewToolWindowForm getToolWindowForm() {
