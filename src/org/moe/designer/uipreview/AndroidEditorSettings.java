...
public class AndroidEditorSettings implements PersistentStateComponent<AndroidEditorSettings.MyState> {
  ...
  private static AndroidEditorSettings mySettings = null;

  public static AndroidEditorSettings getInstance() {
    if (mySettings == null) {
      mySettings = ServiceManager.getService(AndroidEditorSettings.class);
      if (mySettings == null) {
        mySettings = new AndroidEditorSettings();
      }
    }
    return mySettings;
  }
