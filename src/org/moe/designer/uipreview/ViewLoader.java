...
import org.moe.designer.rendering.InconvertibleClassError;
...
//      myLogger.addBrokenClass(className, e);
    ...
    try {
      final Object o = null;//createViewFromSuperclass(className, constructorSignature, constructorArgs);
...
//  }
  ...
  private Object createMockView(String className, Class[] constructorSignature, Object[] constructorArgs)
    ...
    final Class<?> mockViewClass = getProjectClassLoader().loadClass(SdkConstants.CLASS_MOCK_VIEW);// getProjectClassLoader().loadClass(SdkConstants.CLASS_MOCK_VIEW);
...
//        }
        ...
        final String packageName = "com.example.administrator.myapplication";//manifest.getPackage().getValue();
