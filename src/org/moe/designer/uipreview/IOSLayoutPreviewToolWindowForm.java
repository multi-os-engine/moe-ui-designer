 ...
 */
public class IOSLayoutPreviewToolWindowForm implements Disposable, ConfigurationListener, RenderContext,
        OverlayContainer, ResourceFolderManager.ResourceFolderListener {
  private JPanel myContentPanel;
  private IOSLayoutPreviewPanel myPreviewPanel;
  ...
  private final IOSLayoutPreviewToolWindowManager myToolWindowManager;
  ...
  public IOSLayoutPreviewToolWindowForm(IOSLayoutPreviewToolWindowManager toolWindowManager) {
...
//    actionGroup.add(new SaveScreenshotAction(this));
  ...
  @NotNull
  public IOSLayoutPreviewPanel getPreviewPanel() {
