...
import com.android.ide.common.rendering.CustomElementClassLoader;
...
//    ClassLoader urlCL = library.getClassLoader();
//    ClassLoader pluginCL = urlCL.getParent();
//    pluginCL.
...
//  @Override
//  protected Class<?> lo
//  ad(String name) throws ClassNotFoundException {
...
//  }
  ...
  protected URL[] getExternalJars() {
    if(myLibrary.getClassLoader() instanceof URLClassLoader){
      return ((URLClassLoader) myLibrary.getClassLoader()).getURLs();
    }
    return new URL[0];
  }
