 ...
 */
package org.moe.designer.componentTree;
 ...
 */
public final class IOSTreeDecorator implements TreeComponentDecorator {
  @Nullable private final Project myProject;

  public IOSTreeDecorator(@Nullable Project project) {
    myProject = project;
  }
...
//    }
  ...
  private void decorate(RadComponent component,
                               ...
                               boolean full) {
    String id = null;//component.getPropertyValue(ATTR_ID);
    id = null;//LintUtils.stripIdPrefix(id);
