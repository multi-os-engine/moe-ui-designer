...
import org.moe.designer.rendering.Overlay;
import org.moe.designer.rendering.RenderResult;
import org.moe.designer.rendering.RenderedImage;
...
public class RootView extends JComponent implements TransformedComponent {
  ...
  @NotNull private final IOSDesignerEditorPanel myPanel;
  protected int myX;
  protected int myY;
  @Nullable
  RenderedImage myRenderedImage;

  public RootView(@NotNull IOSDesignerEditorPanel panel, int x, int y, @NotNull RenderResult renderResult) {
    myX = x;
    myY = y;
    myPanel = panel;
  ...
  @NotNull
  public IOSDesignerEditorPanel getPanel() {
    return myPanel;
  }
