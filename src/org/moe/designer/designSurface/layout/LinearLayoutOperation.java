 ...
 */
package org.moe.designer.designSurface.layout;
...
import org.moe.designer.android.designer.FillPolicy;
import org.moe.designer.android.designer.ResizeContext;
import org.moe.designer.android.sdk.AndroidPlatform;
import org.moe.designer.designSurface.feedbacks.TextFeedback;
import org.moe.designer.designSurface.graphics.DesignerGraphics;
import org.moe.designer.designSurface.graphics.DrawingStyle;
import org.moe.designer.designSurface.layout.flow.FlowBaseOperation;
import org.moe.designer.model.RadComponentOperations;
import org.moe.designer.model.RadViewComponent;
import org.moe.designer.model.layout.Gravity;
...
import static org.moe.designer.designSurface.graphics.DrawingStyle.SHOW_STATIC_GRID;
...
public class LinearLayoutOperation extends FlowBaseOperation {
  ...
  public void showFeedback() {
    ...
    if (mySetGravity) {
      ...
      //TODO no need to show alignment tooltip
...
//      myTextFeedback.centerTop(myBounds);
  ...
  public void execute() throws Exception {
    ...
    ApplicationManager.getApplication().runWriteAction(new Runnable() {
      @Override
      public void run() {
        Gravity gravity = myHorizontal ? Gravity.top : Gravity.left;
...
//          }
//        }
        tag.setAttribute(ATTR_LAYOUT_GRAVITY, ANDROID_URI, gravity.name());
      }
    }
  }
  ...
  protected final boolean supportsMatchParent() {
    ...
    IOSDesignerEditorPanel panel = IOSDesignerUtils.getPanel(myContext.getArea());
    if (panel != null) {
  ...
  public void execute(boolean horizontal, @Nullable Gravity gravity, @NotNull List<? extends RadViewComponent> components) {
    ...
    // sizes, if used.
    //todo no need to add weight for new element
  ...
  private class GravityFeedback extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
      ...
      if (myComponents.size() == 1) {
        ...
        Dimension size = IOSDesignerUtils.computePreferredSize(myContext.getArea(), first, myContainer);
        Rectangle bounds;
        if (myHorizontal) {
