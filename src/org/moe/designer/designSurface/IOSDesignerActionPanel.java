 ...
 */
package org.moe.designer.designSurface;
...
import org.moe.designer.model.RadViewLayout;
import org.moe.designer.rendering.RefreshRenderAction;
import org.moe.designer.rendering.RenderOptionsMenuBuilder;
...
public class IOSDesignerActionPanel extends DesignerActionPanel {
  public IOSDesignerActionPanel(DesignerEditorPanel designer, JComponent shortcuts) {
    super(designer, shortcuts);

    DefaultActionGroup popupGroup = getPopupGroup();
    popupGroup.addSeparator();
//    popupGroup.add(new SaveScreenshotAction((IOSDesignerEditorPanel)myDesigner));
  }
  ...
  protected JComponent createToolbar() {
    ...
    RenderContext context = (IOSDesignerEditorPanel)myDesigner;
...
//    private final IOSDesignerEditorPanel myPanel;
//
//    private ShowIncludedIn(@NotNull IOSDesignerEditorPanel panel, @Nullable IncludeReference reference, @NotNull String title) {
//      super(title);
//      myPanel = panel;
