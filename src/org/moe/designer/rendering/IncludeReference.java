...
public class IncludeReference {
  ...
  @Nullable
  public static String getIncludingLayout(@NotNull final IXmlFile file) {
...
//  }
   ...
   * given file */
  @NotNull
  public static IncludeReference get(@NotNull final Module module, @NotNull final IXmlFile file, @NotNull final RenderResources resolver) {
    if (!ApplicationManager.getApplication().isReadAccessAllowed()) {
