...
import static org.moe.designer.configurations.ConfigurationListener.CFG_DEVICE;
import static org.moe.designer.configurations.ConfigurationListener.CFG_DEVICE_STATE;
import static org.moe.designer.rendering.ShadowPainter.SHADOW_SIZE;
import static org.moe.designer.rendering.ShadowPainter.SMALL_SHADOW_SIZE;
import static org.moe.designer.rendering.multi.RenderPreviewMode.*;
...
//          label = String.format(Locale.US, "%1$s (%2$s\")", name, Float.toString(length));
//        } else {
