...
import org.moe.designer.android.sdk.*;
...
import static org.moe.designer.configurations.RenderContext.UsageType.LAYOUT_EDITOR;
import static org.moe.designer.rendering.HtmlLinkManager.URL_ACTION_CLOSE;
import static org.moe.designer.rendering.RenderLogger.TAG_STILL_BUILDING;
import static org.moe.designer.rendering.ResourceHelper.viewNeedsPackage;
import static org.moe.designer.android.lint.LintUtils.editDistance;
import static org.moe.designer.android.lint.LintUtils.stripIdPrefix;
...
// TODO: URLs
  ...
  private void appendFlagValueSuggestions(HtmlBuilder builder, RenderProblem message) {
    ...
    if (formats.contains(AttributeFormat.Flag) || formats.contains(AttributeFormat.Enum) || formats.contains(AttributeFormat.Handler)) {
