...
import org.moe.designer.android.dom.AndroidAttributeValue;
...
public class AndroidGotoRelatedProvider extends GotoRelatedProvider {
  ...
  private static Computable<List<GotoRelatedItem>> getLazyItemsComputable(@NotNull PsiElement element) {
    ...
    if (file instanceof PsiJavaFile) {
      ...
      return getLazyItemsForXmlFile((IXmlFile)file, facet);
    }
    return null;
  }

  @Nullable
  public static Computable<List<GotoRelatedItem>> getLazyItemsForXmlFile(@NotNull IXmlFile file, @NotNull AndroidFacet facet) {
  ...
  @Nullable
  private static Computable<List<GotoRelatedItem>> collectRelatedJavaFiles(@NotNull final IXmlFile file,
    ...
    return new Computable<List<GotoRelatedItem>>() {
      ...
      public List<GotoRelatedItem> compute() {
        ...
        PsiClass declared = IOSPsiUtils.getContextClass(module, file);
        if (declared != null) {
