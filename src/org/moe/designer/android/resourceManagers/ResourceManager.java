 ...
 */
package org.moe.designer.android.resourceManagers;

import com.android.resources.ResourceType;
//import com.android.tools.idea.AndroidPsiUtils;
import org.moe.designer.android.AndroidIdIndex;
import org.moe.designer.android.AndroidValueResourcesIndex;
...
import org.moe.designer.android.dom.wrappers.FileResourceElementWrapper;
...
import org.moe.android.util.ResourceEntry;
...
public abstract class ResourceManager {
  ...
  public boolean processFileResources(@Nullable String resourceType, @NotNull FileResourceProcessor processor,
    ...
    for (VirtualFile resSubdir : AndroidResourceUtil.getResourceSubdirs(resourceType, resDirs)) {
      if(resSubdir.getPath().contains(myProject.getBaseDir().getCanonicalPath())){
    ...
    processFileResources(resType1, new FileResourceProcessor() {
      ...
      public boolean process(@NotNull final VirtualFile resFile, @NotNull String resName, @NotNull String resFolderType) {
        ...
        if ((extensions.length == 0 || extensionSet.contains(extension)) &&
          ...
          final PsiFile file = IOSPsiUtils.getPsiFileSafely(myProject, resFile);
          if (file != null) {
            result.add(file);
          }
        }
...
//    }, scope);
    ...
    for (VirtualFile file : getAllValueResourceFiles()) {
//      XmlFile resFile = (XmlFile)IOSPsiUtils.getPsiFileSafely(myProject, file);
