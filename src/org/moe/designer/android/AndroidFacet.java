...
import org.moe.designer.android.compiler.AndroidAutogeneratorMode;
import org.moe.designer.android.compiler.AndroidCompileUtil;
...
public final class AndroidFacet extends Facet<AndroidFacetConfiguration> {
  ...
  public static final FacetTypeId<AndroidFacet> ID = new FacetTypeId<AndroidFacet>("ios-facet");
  ...
  public static AndroidFacet myFacet = null;
...
//  private final Map<AndroidAutogeneratorMode, Set<String>> myAutogeneratedFiles = new HashMap<AndroidAutogeneratorMode, Set<String>>();
  ...
  public AndroidFacet(@NotNull Module module, String name, @NotNull AndroidFacetConfiguration configuration) {
    ...
    //super(new AndroidFacetType(), module, name, configuration, null);
...
//          AndroidResourceFilesListener.notifyFacetInitialized(AndroidFacet.this);
  ...
  public static AndroidFacet getInstance(@NotNull final PsiElement element) {
    Module module = IOSPsiUtils.getModuleSafely(element);
...
//        AndroidPlatform platform = getConfiguration().getAndroidPlatform();
  ...
  public Manifest getManifest() {
    ...
    String path = "C:\\Users\\Administrator\\AndroidStudioProjects\\MyApplication\\app\\src\\main\\AndroidManifest.xml";

//    final VirtualFile manifestFile = LocalFileSystem.getInstance().findFileByIoFile(manifestIoFile);
    final VirtualFile manifestFile = VfsImplUtil.findFileByPath(LocalFileSystem.getInstance(), path);
    if (manifestFile == null) return null;
    PsiFile psiFile = PsiManager.getInstance(getModule().getProject()).findFile(manifestFile);
...
//      return loadDomElementWithReadPermission(project, (XmlFile)psiFile, aClass);
      ...
      DomFileElement<Manifest> element = domManager.getFileElement((XmlFile)psiFile);
