...
public class AttributeDefinition {
  ...
  private Map<String, String> myInternalPresentation = new HashMap<String, String>();
  ...
  public void addInternalName(String attrName, String internalName){
    myInternalPresentation.put(attrName, internalName);
  }

  public String getInternalName(String attrName){
    return myInternalPresentation.get(attrName);
  }
}
