...
//  @Override
  public boolean isMyFile(@NotNull final IXmlFile file, @Nullable Module module) {
    return doIsMyFile(file, myResourceTypes);
  }

  public static boolean doIsMyFile(final IXmlFile file, final String[] resourceTypes) {
