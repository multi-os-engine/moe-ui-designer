...
import org.moe.designer.designSurface.graphics.DirectionResizePoint;
import org.moe.designer.designSurface.graphics.DrawingStyle;
import org.moe.designer.designSurface.graphics.RectangleFeedback;
...
public class ResizeOperation implements EditOperation {
  ...
  public void execute() throws Exception {
    if(AndroidWidgetUtils.isResizable(myComponent, null, myComponent.getBounds().getHeight() != getResizedBounds().getHeight())){
