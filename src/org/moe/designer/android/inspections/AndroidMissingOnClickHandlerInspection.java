package org.moe.designer.android.inspections;

import com.android.resources.ResourceType;
import org.moe.designer.android.AndroidFacet;
import org.moe.designer.android.AndroidGotoRelatedProvider;
import org.moe.designer.android.dom.AndroidCreateOnClickHandlerAction;
import org.moe.designer.android.dom.converters.OnClickConverter;
import org.moe.designer.android.dom.layout.LayoutDomFileDescription;
...
public class AndroidMissingOnClickHandlerInspection extends LocalInspectionTool {
  @NotNull
  private static Collection<PsiClass> findRelatedActivities(@NotNull IXmlFile file,
  ...
  @NotNull
  private static Set<PsiClass> findRelatedActivitiesForMenu(@NotNull IXmlFile file, @NotNull AndroidFacet facet) {
...
//      return ProblemDescriptor.EMPTY_ARRAY;
//    }
    final Collection<PsiClass> activities = findRelatedActivities((IXmlFile)file, facet, description);
