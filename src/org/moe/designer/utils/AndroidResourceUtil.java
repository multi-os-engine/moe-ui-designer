...
import org.moe.designer.android.AndroidFileTemplateProvider;
import org.moe.designer.android.augment.AndroidPsiElementFinder;
import org.moe.designer.android.dom.resources.Item;
import org.moe.designer.android.dom.resources.ResourceElement;
import org.moe.designer.android.dom.resources.Resources;
import org.moe.designer.android.dom.wrappers.LazyValueResourceElementWrapper;
import org.moe.designer.android.sdk.AndroidPlatform;
import org.moe.designer.android.utils.AndroidCommonUtils;
import org.moe.designer.android.utils.AndroidUtils;
import org.moe.designer.fileTemplates.IXMLFileTemplateUtil;
...
//  }
  ...
  @NotNull
  public static IXmlFile createFileResource(@NotNull String fileName,
    ...
    PsiElement createdElement = IXMLFileTemplateUtil.createFromTemplate(template, fileName, properties, resSubdir);
    assert createdElement instanceof IXmlFile;
    return (IXmlFile)createdElement;
  }

  @NotNull
  public static IXmlFile createIXmlFileResource(@NotNull String fileName,
                                            @NotNull PsiDirectory resSubdir,
                                            @NotNull String rootTagName,
                                            @NotNull String resourceType,
                                            boolean valuesResourceFile) throws Exception {
    ...
    final PsiElement createdElement = IXMLFileTemplateUtil.createFromTemplate(template, fileName, properties, resSubdir);
    assert createdElement instanceof IXmlFile;

    ApplicationManager.getApplication().runWriteAction(new Runnable() {
      @Override
      public void run() {
        ((IXmlFile) createdElement).getDocument().getRootTag().setAttribute("xmlns:xrt", "http://schemas.android.com/apk/res/android");
      }
    });
