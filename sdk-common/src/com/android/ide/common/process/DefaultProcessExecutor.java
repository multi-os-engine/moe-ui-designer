        ...
        Thread threadErr = new Thread("stderr") {
            ...
            public void run() {
                ...
                try {
                    ...
                    try {
                        if (stderr != null) Closeables.close(stderr, true /* swallowIOException */);
                    } catch (IOException e) {
                        // cannot happen
                    }
                    try {
                        if (stream != null) Closeables.close(stream, true /* swallowIOException */);
                    } catch (IOException e) {
                        // cannot happen
                    }
        ...
        Thread threadOut = new Thread("stdout") {
            ...
            public void run() {
                ...
                try {
                    ...
                    stream = output.getStandardOutput();
                    ...
                    try {
                        if (stdout != null) Closeables.close(stdout, true /* swallowIOException */);
                    } catch (IOException e) {
                        // cannot happen
                    }
                    try {
