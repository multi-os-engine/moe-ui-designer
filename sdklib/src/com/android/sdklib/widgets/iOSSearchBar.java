...
public class iOSSearchBar extends EditText implements  iOSBaseElement {
    public iOSSearchBar(Context context) {
        super(context);
    }

    public iOSSearchBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public iOSSearchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public iOSSearchBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
