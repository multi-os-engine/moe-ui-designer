...
public class iOSTextView extends TextView implements iOSView, iOSITextView, iOSBaseElement {
    ...
    public iOSTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
