...
public class iOSButton extends Button implements iOSITextView, iOSView, iOSBaseElement {
    ...
    public iOSButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
