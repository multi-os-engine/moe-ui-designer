...
import com.android.sdklib.widgets.base_elements.iOSBaseSeekBar;
import com.android.sdklib.widgets.base_elements.iOSProgressBar;
import com.android.sdklib.widgets.base_elements.iOSView;

public class iOSSlider extends SeekBar implements iOSProgressBar, iOSBaseElement {
    ...
    public iOSSlider(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
